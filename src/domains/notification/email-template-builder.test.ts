...
describe('EmailTemplateBuilder', () => {
    describe('confirmationEmail', () => {
        const params = {
            owner: 'golang',
            repo: 'go',
            confirmUrl: 'http://example.com/confirm/abc',
            unsubscribeUrl: 'http://example.com/unsubscribe?token=tok',
        };
        ...
        it('includes owner/repo, confirmUrl and unsubscribeUrl in html', () => {
            ...
            expect(html).toContain('http://example.com/unsubscribe?token=tok');
        });
    });
