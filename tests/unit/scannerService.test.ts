...
const mockRepos = repository.findAllDistinctReposConfirmed as jest.MockedFunction<typeof repository.findAllDistinctReposConfirmed>;
const mockSubscribers = repository.findConfirmedSubscribersByRepo as jest.MockedFunction<typeof repository.findConfirmedSubscribersByRepo>;
